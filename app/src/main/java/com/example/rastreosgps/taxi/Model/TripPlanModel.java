package com.example.rastreosgps.taxi.Model;

public class TripPlanModel {

    private String rider,driver;
    private DriverInfoModel driverModel;
    ...
    public DriverInfoModel getDriverModel() {
        return driverModel;
    }

    public void setDriverModel(DriverInfoModel driverModel) {
